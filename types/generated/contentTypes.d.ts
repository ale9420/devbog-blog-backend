...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coverCredit: Schema.Attribute.Component<'shared.image-credit', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    key: Schema.Attribute.Enumeration<['privacidad', 'diy', 'ia', 'software', 'linux']> &
      Schema.Attribute.Unique &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    pillar: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    fediverseHeader: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginCommentsCommentReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'plugin::comments.comment-report'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
